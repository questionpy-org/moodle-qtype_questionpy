...
$string['applicationserverpassword_description'] = 'The Password to access the Application Server';
$string['maxservertimeout'] = 'Server timeout time';
$string['maxservertimeout_description'] = 'Server timeout time in seconds';
$string['maxquestionsize'] = 'Maximum file size of a QuestionPy package';
$string['maxquestionsize_description'] = 'Maximum file size in kB';
