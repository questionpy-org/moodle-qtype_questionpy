...
use qtype_questionpy\local\array_converter\test_classes\polymorphic;
use qtype_questionpy\local\array_converter\test_classes\simple;
use qtype_questionpy\local\array_converter\test_classes\uses_element_class;
use qtype_questionpy\local\array_converter\test_classes\uses_rename_and_alias;
use qtype_questionpy\local\array_converter\test_classes\variant2;

/**
 * Tests of {@see array_converter}.
 *
 * @covers \qtype_questionpy\local\array_converter
 *
...
final class array_converter_test extends \advanced_testcase {
    ...
    public function test_should_deserialize_polymorphic_fallback(): void {
        ...
        $this->assertDebuggingCalled("Unknown value for discriminator 'discriminator': 'abcdefg'. Using fallback "
            . "variant 'qtype_questionpy\\local\\array_converter\\test_classes\\simple'.");
    }
}
